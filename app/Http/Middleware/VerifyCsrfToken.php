...
class VerifyCsrfToken extends Middleware {
    ...
    ['/api/countrylist', '/api/register', '/api/verify-otp', 
     ...
     '/api/add-to-wishlist', '/api/my-wishlist', '/api/remove-from-wishlist',
     '/api/couponlist', '/api/edit-profile', '/api/my-address', 
     '/api/add-edit-address', '/api/delete-address', '/api/referral-history', 
     ...
     '/api/product-faqs','/api/initiatePayment','/api/payment-webhook','/api/my-reviews','/api/increase-decrease-quantity','/api/state-list','/api/city-list','/api/my-orders','/api/summary','/api/order-history','/api/apply-coin'];
}
