...
class VerifyCsrfToken extends Middleware {
    ...
    ['/api/countrylist', '/api/register', '/api/verify-otp', 
     ...
     '/api/product-faqs','/api/initiatePayment','/api/payment-webhook','/api/my-reviews','/api/increase-decrease-quantity','/api/state-list','/api/city-list','/api/my-orders','/api/summary'];
}
