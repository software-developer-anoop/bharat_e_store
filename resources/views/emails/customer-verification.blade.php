...
<body>
    <p>Thank you for registering. Please verify your email by entering the otp :</p>


    <h2>Your login OTP is {{ $data['otp'] }}. Do not share it with anyone. Thank you, Bharat E Store – NANDRHYTH BANYAN LLP.</h2>
