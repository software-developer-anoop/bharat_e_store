        ...
        <div class="table-responsive mb-4 mt-4">
          <table id="alter_pagination" class="table table-hover" style="width:100%">
            ...
            <tbody>
              ...
              <tr id="del_{{$value->id}}">
                <td class="text-center">{{$value->customer_name??'N/A'}} / <br> {{$value->customer_phone??'N/A'}} / <br> {{$value->customer_email??'N/A'}}</td>
                <td class="text-center">{{$value->customer_gender??'N/A'}}</td>
                <td class="text-center">
                    <a href="javascript:void(0)" 
                       onclick="return changeStatus('{{ $value->profile_status == 'Active' ? 'Inactive' : 'Active' }}', {{ $value->id }}, 'customers')" 
                       title="Change To {{ $value->profile_status == 'Active' ? 'Inactive' : 'Active' }}" >
                ...
                <td class="text-center">
                  ...
                  <a href="javascript:void(0)" onclick="return deleteItem({{$value->id}},'customers')" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete">
