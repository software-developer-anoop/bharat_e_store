            ...
            <tbody>
              ...
              <tr id="del_{{$value->id}}">
                ...
                <td class="text-center">
                  ...
                  <a href="javascript:void(0)" onclick="return broadCastNotification({{$value->id}})" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Send Notification">
