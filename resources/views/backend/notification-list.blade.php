              ...
              <tr id="del_{{$value->id}}">
                ...
                <td class="text-center">
                    <a href="javascript:void(0)" 
                       onclick="return changeStatus('{{ $value->status == 'Active' ? 'Inactive' : 'Active' }}', {{ $value->id }}, 'notifications')" 
                ...
                <td class="text-center">
                  <a href="{{route('admin.edit-notification',$value->id)}}" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
                  ...
                  <a href="javascript:void(0)" onclick="return deleteItem({{$value->id}},'notifications')" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete">
                  ...
                  <a href="javascript:void(0)" onclick="return broadCastNotification({{$value->id}},0,100)" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Send Notification">
