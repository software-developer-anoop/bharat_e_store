        ...
        <div class="table-responsive mb-4 mt-4">
          <table id="alter_pagination" class="table table-hover" style="width:100%">
            ...
            <tbody>
              ...
              <tr id="del_{{$value->id}}">
                <td class="text-center">{{$value->country_name??''}}</td>
                <td class="text-center">{{$value->state_name??''}}</td>
                <td class="text-center">
                    <a href="javascript:void(0)" 
                       onclick="return changeStatus('{{ $value->status == 'Active' ? 'Inactive' : 'Active' }}', {{ $value->id }}, 'states')" 
                ...
                <td class="text-center">
                  <a href="{{route('admin.edit-state',$value->id)}}" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
                  ...
                  <a href="javascript:void(0)" onclick="return deleteItem({{$value->id}},'states')" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete">
