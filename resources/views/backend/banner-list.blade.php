      ...
      <div class="widget-content widget-content-area br-6">
        <div class="table-responsive mb-4 mt-4">
          <table id="alter_pagination" class="table table-hover" style="width:100%">
            <thead>
              <tr>
                <th class="text-center">Category Name / <br> Subcategory Name</th>
            ...
            <tbody>
              ...
              <tr id="del_{{$value->id}}">
                <td class="text-center">{{$value->category_name??''}} / <br>  {{$value->subcategory_name??''}}</td>
                @if($value->image)
                ...
                <td class="text-center">
                    <a href="javascript:void(0)" 
                       onclick="return changeStatus('{{ $value->status == 'Active' ? 'Inactive' : 'Active' }}', {{ $value->id }}, 'banner_list')" 
                ...
                <td class="text-center">
                  <a href="{{route('admin.edit-banner',$value->id)}}" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
                  ...
                  <a href="javascript:void(0)" onclick="return deleteItem({{$value->id}},'banner_list')" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete">
