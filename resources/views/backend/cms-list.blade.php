          ...
          <table id="alter_pagination" class="table table-hover" style="width:100%">
            ...
            <tbody>
              ...
              <tr id="del_{{$value->id}}">
                ...
                <td class="text-center">{{$value->created_at??'N/A'}}</td>
                <td class="text-center">{{$value->updated_at??'N/A'}}</td>
                <td class="text-center">
                  <a href="{{route('admin.edit-cms-page',$value->id)}}" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
                  ...
                  <a href="javascript:void(0)" onclick="return deleteItem({{$value->id}},'cms_pages')" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete">
