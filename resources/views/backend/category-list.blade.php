          ...
          <table id="alter_pagination" class="table table-hover" style="width:100%">
            ...
            <tbody>
              ...
              <tr id="del_{{$value->id}}">
                ...
                <td class="text-center"><img src="{{$value->category_image?asset('uploads/'.$value->category_image):''}}" width="100"></td>
                @else
                <td class="text-center">N/A</td>
                @endif
                <td class="text-center">
                    <a href="javascript:void(0)" 
                       onclick="return changeStatus('{{ $value->status == 'Active' ? 'Inactive' : 'Active' }}', {{ $value->id }}, 'categories')" 
                ...
                <td class="text-center">
                  <a href="{{route('admin.edit-category',$value->id)}}" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
                  ...
                  <a href="javascript:void(0)" onclick="return deleteItem({{$value->id}},'categories')" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete">
