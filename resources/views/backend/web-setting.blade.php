            ...
            <div class="row">
              ...
              <div class="col-lg-3 col-12">
                <div class="form-group">
                  ...
                  <input id="mobile_number" type="tel" name="mobile_number" placeholder="Mobile Number" class="form-control numbersWithZeroOnlyInput" maxlength="20" minlength="20" autocomplete="off" required value="{{$web->mobile_number??''}}">
                </div>
              </div>
              <div class="col-lg-3 col-12">
                <div class="form-group">
