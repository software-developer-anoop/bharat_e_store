            ...
            <tbody>
              ...
              <tr id="del_{{$value->id}}">
                ...
                <td class="text-center">
                  <a href="{{route('admin.edit-address',$value->id)}}" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
                  ...
                  <a href="javascript:void(0)" onclick="return deleteItem({{$value->id}},'addresses')" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete">
